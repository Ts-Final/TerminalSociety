...
export interface how2play extends GameDataInterface{
  id: number
  name: string
  info: string
...
export class How2PlayClass extends GameDataClass{
  ...
  static updateRef() {
    ...
    this.refs.all.value = results
  }
}

export const How2Play = How2PlayClass.fromData(...How2PlayData)
window.dev.h2p = {How2Play, How2PlayClass}